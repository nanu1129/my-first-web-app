...
AP.parts = [
  { id: 'basics',   name: '基礎理論',
    desc: '基数変換・論理演算・データ構造とアルゴリズム', icon: '∑' },
  { id: 'computer', name: 'コンピュータシステム',
    desc: 'プロセッサ・メモリ・システム構成と信頼性・OS', icon: '🖥' },
  { id: 'database', name: 'データベース',
    desc: '関係モデル・正規化・SQL・トランザクション', icon: '🗄' },
  { id: 'network',  name: 'ネットワーク',
    desc: 'TCP/IP・IPアドレス・ルーティング・プロトコル', icon: '🌐' },
  { id: 'security', name: 'セキュリティ',
    desc: '暗号・認証・PKI・攻撃手法と対策', icon: '🔐' },
  { id: 'dev',      name: '開発技術',
    desc: '開発プロセス・設計手法・テスト技法', icon: '🛠' },
  { id: 'management', name: 'マネジメント',
    desc: 'プロジェクトマネジメント・サービスマネジメント・監査', icon: '📋' },
  { id: 'strategy', name: 'ストラテジ',
    desc: '経営戦略・システム戦略・企業会計と法務', icon: '📈' },
];
